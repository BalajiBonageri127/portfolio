$(function() {
    ...
    $(".openBtn").on("click", function(event) {
        ...
        History.pushState(
            null,
            null,
            window.location.href + "&pitem=" + $(this).attr("href")
        );
    ...
    $(document).on("click", ".naviguationportfolio .nextportfolio", function() {
        ...
        var nextitem =
            portfolioitems[
                ($.inArray(acturllnav, portfolioitems) + 1) %
                    portfolioitems.length
            ];
        History.replaceState(
            null,
            null,
            url().replace("&pitem=" + url("?pitem"), "&pitem=" + nextitem)
        );
        $.loadmodal({
            url: nextitem,
            title: "",
    ...
    $(".button-single-post").on("click", function(event) {
        ...
        History.pushState(
            null,
            null,
            window.location.href + "&bitem=" + $(this).attr("href")
        );
    });
            ...
            stories: [
                {
                    ...
                    name: "STORIES",
                    link: "",
                    lastUpdated: 1680863400,
                    items: [
                        buildItem(
                            "johndoe-1",
                            "video",
                            5,
                            "images/stories/1.mp4",
                            "images/stories/1.mp4",
                            "",
                            false,
                            1680863400
                    ...
                    /*   buildItem(
                            ...
                            "photo",
                            5,
                            "images/portfolio/thumb-cranehouse.jpg",
                            "images/portfolio/thumb-cranehouse.jpg",
                            "",
                            false,
                            1505845276
                        ...
                        buildItem(
                            ...
                            "photo",
                            5,
                            "images/portfolio/thumb-elucidator.jpg",
                            "images/portfolio/thumb-elucidator.jpg",
                            "",
                            false,
                            1505845276
                        ...
                        buildItem(
                            ...
                            "photo",
                            5,
                            "images/portfolio/thumb-krishna.jpg",
                            "images/portfolio/thumb-krishna.jpg",
                            "",
                            false,
                            1505845276
                        ...
                        buildItem(
                            ...
                            "photo",
                            5,
                            "images/portfolio/thumb-medieval-table.jpg",
                            "images/portfolio/thumb-medieval-table.jpg",
                            "",
                            false,
                            1505845276
                        ...
                        buildItem(
                            ...
                            "photo",
                            5,
                            "images/portfolio/thumb-sniper.jpg",
                            "images/portfolio/thumb-sniper.jpg",
                            "",
                            false,
                            1505845276
                        ...
                        buildItem(
                            ...
                            "photo",
                            5,
                            "images/portfolio/thumb-turret.jpg",
                            "images/portfolio/thumb-turret.jpg",
                            "",
                            false,
                            1505845276
...
!(function() {
    var data = [
        {
            eventName: "Meeting With Developers",
            calendar: "Work",
            color: "red"
        },
        {
            eventName: "Workshop - Web Developers",
            calendar: "Work",
            color: "red"
        },
        ...
        {
            eventName: "San Degio vs Portalnd",
            calendar: "Sports",
            color: "blue"
        },
